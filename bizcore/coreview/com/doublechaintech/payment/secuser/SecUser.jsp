<%@ page import='java.util.*,com.doublechaintech.payment.*,com.doublechaintech.payment.secuser.SecUser'%>
...
<sky:include page="com/doublechaintech/payment/secuser/SecUser$Summary.jsp" />
...
<sky:include page="com/doublechaintech/payment/userdomain/UserDomain$Info.jsp" />
...
<sky:include page="com/doublechaintech/payment/secuserblocking/SecUserBlocking$Action.jsp" />
		...
		<div id="userAppList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/doublechaintech/payment/userapp/UserApp$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["loginHistoryList"] or ignoreListAccessControl}'>
		...
		<div id="loginHistoryList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/doublechaintech/payment/loginhistory/LoginHistory$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
