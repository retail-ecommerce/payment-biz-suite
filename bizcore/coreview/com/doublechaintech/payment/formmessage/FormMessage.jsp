<%@ page import='java.util.*,com.doublechaintech.payment.*,com.doublechaintech.payment.formmessage.FormMessage'%>
...
<sky:include page="com/doublechaintech/payment/formmessage/FormMessage$Summary.jsp" />
