<%@ page import='java.util.*,com.doublechaintech.payment.*,com.doublechaintech.payment.userapp.UserApp'%>
...
<sky:include page="com/doublechaintech/payment/userapp/UserApp$Summary.jsp" />
...
<sky:include page="com/doublechaintech/payment/secuser/SecUser$Info.jsp" />
		...
		<div id="listAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/doublechaintech/payment/listaccess/ListAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["objectAccessList"] or ignoreListAccessControl}'>
		...
		<div id="objectAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/doublechaintech/payment/objectaccess/ObjectAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
