<%@ page import='java.util.*,com.doublechaintech.payment.*,com.doublechaintech.payment.secuserblocking.SecUserBlocking'%>
...
<sky:include page="com/doublechaintech/payment/secuserblocking/SecUserBlocking$Summary.jsp" />
