<%@ page import='java.util.*,com.doublechaintech.payment.*,com.doublechaintech.payment.platform.Platform'%>
...
<sky:include page="com/doublechaintech/payment/platform/Platform$Summary.jsp" />
