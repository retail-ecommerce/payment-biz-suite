<%@ page import='java.util.*,com.doublechaintech.payment.*,com.doublechaintech.payment.listaccess.ListAccess'%>
...
<sky:include page="com/doublechaintech/payment/listaccess/ListAccess$Summary.jsp" />
