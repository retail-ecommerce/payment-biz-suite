<%@ page import='java.util.*,com.doublechaintech.payment.*,com.doublechaintech.payment.formfieldmessage.FormFieldMessage'%>
...
<sky:include page="com/doublechaintech/payment/formfieldmessage/FormFieldMessage$Summary.jsp" />
...
<sky:include page="com/doublechaintech/payment/genericform/GenericForm$Info.jsp" />
