<%@ page import='java.util.*,com.doublechaintech.payment.*,com.doublechaintech.payment.userwhitelist.UserWhiteList'%>
...
<sky:include page="com/doublechaintech/payment/userwhitelist/UserWhiteList$Summary.jsp" />
