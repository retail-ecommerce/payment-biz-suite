<%@ page import='java.util.*,com.doublechaintech.payment.*,com.doublechaintech.payment.objectaccess.ObjectAccess'%>
...
<sky:include page="com/doublechaintech/payment/objectaccess/ObjectAccess$Summary.jsp" />
...
<sky:include page="com/doublechaintech/payment/userapp/UserApp$Info.jsp" />
