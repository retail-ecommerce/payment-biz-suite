...
public class CustomSecUserManagerImpl extends SecUserManagerImpl implements
    ...
    public String confirmSession(PaymentUserContext userContext){
    ...
    public Object resetPassword(PaymentUserContext userContext, String mobile, int verifycationCode, String newPassword) {
    ...
    public Object resetPasswordWithoutLogin(PaymentUserContext userContext, String loginType, String loginKey, int verifycationCode, String newPassword) {
        SecUser user;
        try {
    ...
    public Object selectApp(PaymentUserContext userContext,
    ...
    public SecUser manage(PaymentUserContext userContext) throws Exception{
        SecUser user = cachedUser(userContext);
    ...
    protected SecUser cachedUser(PaymentUserContext userContext)
    {
        return (SecUser)userContext.getCachedObject(this.getUserKey(userContext), SecUser.class);
    }
    
    public SecUser getCachedSecUser(PaymentUserContext userContext) {
    ...
    protected Object gotoApp(PaymentUserContext userContext, UserApp app) throws Exception {
    ...
    public String getVerificationCode(PaymentUserContext userContext,String mobile){
    ...
    protected void sendVerificationCode(PaymentUserContext userContext, String mobile,String code) throws Exception{
    ...
    protected int getRandomVerificationCode(PaymentUserContext userContex, int length){
    ...
    protected String getBeanName(PaymentUserContext userContext, UserApp app){
    ...
    protected String getTargetObjectId(PaymentUserContext userContext, UserApp app){
        
        return  app.getObjectId();
        
    }
    protected String getServiceType(PaymentUserContext userContext, UserApp app){
        
        return app.getObjectType();
    }
    protected String getMethodName(PaymentUserContext userContext, UserApp app){
    ...
    public Object home(PaymentUserContext userContext) {
    ...
    public Object loginWithEmail(PaymentUserContext userContext, String email,
            String password) {

        return loginInternal(userContext,"email",email, password);
    
    }
    public Object login(PaymentUserContext userContext, String email,
            String password) {
    ...
    public Object loginWithLogin(PaymentUserContext userContext, String email,
            String password) {

        return loginInternal(userContext,"login",email, password);
    
    }
    public Object loginWithMobile(PaymentUserContext userContext, String email,
            String password) {
        return loginInternal(userContext,"mobile",email, password);
    
    }
    protected SecUser loadUserWith(PaymentUserContext userContext, String type, String userId) throws Exception{
    ...
    protected Object loginInternal(PaymentUserContext userContext, String type, String userId,
            String password) {
     ...
     */
    protected Object loginTheSecUserInternal(PaymentUserContext userContext, SecUser user, String loginComments) throws Exception {
    ...
    public Object showlogin(PaymentUserContext userContext) {
    ...
    protected LoginForm showSessionExpired(PaymentUserContext userContext) {
    ...
    public BaseUserContext loadUserConext(HttpServletRequest request)
        ...
        PaymentUserContextImpl uc = createNewConext(path);
        init(uc, request);
        return uc;
    }
    ...
    protected PaymentChecker checker;
    ...
    protected void init(UserContextImpl userContext, HttpServletRequest request) {
        ...
        userContext.setChecker((PaymentChecker)beanFactory.getBean(getCheckerBeanName()));
    ...
    protected PaymentUserContextImpl createNewConext(String path) {

        return new PaymentUserContextImpl();
    ...
    public Object checkOtherLogin(PaymentUserContext userContext) throws Exception {
	...
	protected void checkUserHasManagementAccess(PaymentUserContext userContext, String objectType, String objectId)
	...
	public UserApp updateAppPermission(PaymentUserContext userContext, String secUserId, String userAppId, int version,
	...
	public UserApp updateListAccess(PaymentUserContext userContext, String secUserId, String userAppId, String displayName,
	...
	public UserApp loadUserAppWithUser(PaymentUserContext userContext, String secUserId, String objectType,
    ...
    public Object changeCurUserPassword(PaymentUserContext userContext, String currentPassword, String newPassword)
			throws Exception {
	...
	public String testIfHasManagementAccess(PaymentUserContext userContext,String objectType,String objectId) {
		try {
			this.checkUserHasManagementAccess(userContext, objectType, objectId);
			return "OK";
		}catch(Exception e){
