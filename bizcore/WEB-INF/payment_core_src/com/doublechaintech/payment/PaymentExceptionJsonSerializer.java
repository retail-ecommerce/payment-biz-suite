...
public class PaymentExceptionJsonSerializer extends  JsonSerializer<PaymentException> {
	...
	@Override
	public void serialize(PaymentException exception, JsonGenerator jgen,
	...
	protected void writeExceptionMessage(String message, PaymentException exception,
	...
	protected void writeStartObject(PaymentException exception, JsonGenerator jgen,SerializerProvider provider)throws IOException,JsonProcessingException{
		jgen.writeStartObject();
		writeClassField(CLASS,exception,jgen,provider);
	}
	
	private static final String MESSAGE_LIST = "messageList";
	protected void writeEndObject(PaymentException exception, JsonGenerator jgen,SerializerProvider provider)throws IOException,JsonProcessingException{
		
		writeMessageList(MESSAGE_LIST,exception,jgen,provider);
		jgen.writeEndObject();
	}
	protected void writeClassField(String fieldName,PaymentException exception,
	...
	protected void writeMessageList(String fieldName,PaymentException exception,
			JsonGenerator jgen, SerializerProvider provider)
			throws IOException, JsonProcessingException {
		if(exception == null){
			return; //do nothing when base entity is null
