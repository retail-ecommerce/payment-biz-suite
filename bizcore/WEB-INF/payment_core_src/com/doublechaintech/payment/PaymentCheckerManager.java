...
public class PaymentCheckerManager extends BaseManagerImpl {
	/*
	
	
	public static final String  ID_OF_PLATFORM ="platform.id";
	protected void checkIdOfPlatform(PaymentUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkNameOfPlatform(PaymentUserContext userContext, String name, List<Message> messageList)
	{
	...
	protected void checkIntroductionOfPlatform(PaymentUserContext userContext, String introduction, List<Message> messageList)
	{
	...
	protected void checkCurrentVersionOfPlatform(PaymentUserContext userContext, String currentVersion, List<Message> messageList)
	{
	...
	protected void checkVersionOfPlatform(PaymentUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfUserDomain(PaymentUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkNameOfUserDomain(PaymentUserContext userContext, String name, List<Message> messageList)
	{
	...
	protected void checkVersionOfUserDomain(PaymentUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfUserWhiteList(PaymentUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkUserIdentityOfUserWhiteList(PaymentUserContext userContext, String userIdentity, List<Message> messageList)
	{
	...
	protected void checkUserSpecialFunctionsOfUserWhiteList(PaymentUserContext userContext, String userSpecialFunctions, List<Message> messageList)
	{
	...
	protected void checkDomainIdOfUserWhiteList(PaymentUserContext userContext, String domainId, List<Message> messageList)
	{
	...
	protected void checkVersionOfUserWhiteList(PaymentUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfSecUser(PaymentUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkLoginOfSecUser(PaymentUserContext userContext, String login, List<Message> messageList)
	{
	...
	protected void checkMobileOfSecUser(PaymentUserContext userContext, String mobile, List<Message> messageList)
	{
	...
	protected void checkEmailOfSecUser(PaymentUserContext userContext, String email, List<Message> messageList)
	{
	...
	protected void checkPwdOfSecUser(PaymentUserContext userContext, String pwd, List<Message> messageList)
	{
	...
	protected void checkVerificationCodeOfSecUser(PaymentUserContext userContext, int verificationCode, List<Message> messageList)
	{
	...
	protected void checkVerificationCodeExpireOfSecUser(PaymentUserContext userContext, DateTime verificationCodeExpire, List<Message> messageList)
	{
	...
	protected void checkLastLoginTimeOfSecUser(PaymentUserContext userContext, DateTime lastLoginTime, List<Message> messageList)
	{
	...
	protected void checkDomainIdOfSecUser(PaymentUserContext userContext, String domainId, List<Message> messageList)
	{
	...
	protected void checkVersionOfSecUser(PaymentUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfSecUserBlocking(PaymentUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkWhoOfSecUserBlocking(PaymentUserContext userContext, String who, List<Message> messageList)
	{
	...
	protected void checkCommentsOfSecUserBlocking(PaymentUserContext userContext, String comments, List<Message> messageList)
	{
	...
	protected void checkVersionOfSecUserBlocking(PaymentUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfUserApp(PaymentUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkTitleOfUserApp(PaymentUserContext userContext, String title, List<Message> messageList)
	{
	...
	protected void checkSecUserIdOfUserApp(PaymentUserContext userContext, String secUserId, List<Message> messageList)
	{
	...
	protected void checkAppIconOfUserApp(PaymentUserContext userContext, String appIcon, List<Message> messageList)
	{
	...
	protected void checkFullAccessOfUserApp(PaymentUserContext userContext, boolean fullAccess, List<Message> messageList)
	{
	...
	protected void checkPermissionOfUserApp(PaymentUserContext userContext, String permission, List<Message> messageList)
	{
	...
	protected void checkObjectTypeOfUserApp(PaymentUserContext userContext, String objectType, List<Message> messageList)
	{
	...
	protected void checkObjectIdOfUserApp(PaymentUserContext userContext, String objectId, List<Message> messageList)
	{
	...
	protected void checkLocationOfUserApp(PaymentUserContext userContext, String location, List<Message> messageList)
	{
	...
	protected void checkVersionOfUserApp(PaymentUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfListAccess(PaymentUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkNameOfListAccess(PaymentUserContext userContext, String name, List<Message> messageList)
	{
	...
	protected void checkInternalNameOfListAccess(PaymentUserContext userContext, String internalName, List<Message> messageList)
	{
	...
	protected void checkReadPermissionOfListAccess(PaymentUserContext userContext, boolean readPermission, List<Message> messageList)
	{
	...
	protected void checkCreatePermissionOfListAccess(PaymentUserContext userContext, boolean createPermission, List<Message> messageList)
	{
	...
	protected void checkDeletePermissionOfListAccess(PaymentUserContext userContext, boolean deletePermission, List<Message> messageList)
	{
	...
	protected void checkUpdatePermissionOfListAccess(PaymentUserContext userContext, boolean updatePermission, List<Message> messageList)
	{
	...
	protected void checkExecutionPermissionOfListAccess(PaymentUserContext userContext, boolean executionPermission, List<Message> messageList)
	{
	...
	protected void checkAppIdOfListAccess(PaymentUserContext userContext, String appId, List<Message> messageList)
	{
	...
	protected void checkVersionOfListAccess(PaymentUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfObjectAccess(PaymentUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkNameOfObjectAccess(PaymentUserContext userContext, String name, List<Message> messageList)
	{
	...
	protected void checkObjectTypeOfObjectAccess(PaymentUserContext userContext, String objectType, List<Message> messageList)
	{
	...
	protected void checkList1OfObjectAccess(PaymentUserContext userContext, String list1, List<Message> messageList)
	{
	...
	protected void checkList2OfObjectAccess(PaymentUserContext userContext, String list2, List<Message> messageList)
	{
	...
	protected void checkList3OfObjectAccess(PaymentUserContext userContext, String list3, List<Message> messageList)
	{
	...
	protected void checkList4OfObjectAccess(PaymentUserContext userContext, String list4, List<Message> messageList)
	{
	...
	protected void checkList5OfObjectAccess(PaymentUserContext userContext, String list5, List<Message> messageList)
	{
	...
	protected void checkList6OfObjectAccess(PaymentUserContext userContext, String list6, List<Message> messageList)
	{
	...
	protected void checkList7OfObjectAccess(PaymentUserContext userContext, String list7, List<Message> messageList)
	{
	...
	protected void checkList8OfObjectAccess(PaymentUserContext userContext, String list8, List<Message> messageList)
	{
	...
	protected void checkList9OfObjectAccess(PaymentUserContext userContext, String list9, List<Message> messageList)
	{
	...
	protected void checkAppIdOfObjectAccess(PaymentUserContext userContext, String appId, List<Message> messageList)
	{
	...
	protected void checkVersionOfObjectAccess(PaymentUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfLoginHistory(PaymentUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkFromIpOfLoginHistory(PaymentUserContext userContext, String fromIp, List<Message> messageList)
	{
	...
	protected void checkDescriptionOfLoginHistory(PaymentUserContext userContext, String description, List<Message> messageList)
	{
	...
	protected void checkSecUserIdOfLoginHistory(PaymentUserContext userContext, String secUserId, List<Message> messageList)
	{
	...
	protected void checkVersionOfLoginHistory(PaymentUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfGenericForm(PaymentUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkTitleOfGenericForm(PaymentUserContext userContext, String title, List<Message> messageList)
	{
	...
	protected void checkDescriptionOfGenericForm(PaymentUserContext userContext, String description, List<Message> messageList)
	{
	...
	protected void checkVersionOfGenericForm(PaymentUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfFormMessage(PaymentUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkTitleOfFormMessage(PaymentUserContext userContext, String title, List<Message> messageList)
	{
	...
	protected void checkFormIdOfFormMessage(PaymentUserContext userContext, String formId, List<Message> messageList)
	{
	...
	protected void checkLevelOfFormMessage(PaymentUserContext userContext, String level, List<Message> messageList)
	{
	...
	protected void checkVersionOfFormMessage(PaymentUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfFormFieldMessage(PaymentUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkTitleOfFormFieldMessage(PaymentUserContext userContext, String title, List<Message> messageList)
	{
	...
	protected void checkParameterNameOfFormFieldMessage(PaymentUserContext userContext, String parameterName, List<Message> messageList)
	{
	...
	protected void checkFormIdOfFormFieldMessage(PaymentUserContext userContext, String formId, List<Message> messageList)
	{
	...
	protected void checkLevelOfFormFieldMessage(PaymentUserContext userContext, String level, List<Message> messageList)
	{
	...
	protected void checkVersionOfFormFieldMessage(PaymentUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfFormField(PaymentUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkLabelOfFormField(PaymentUserContext userContext, String label, List<Message> messageList)
	{
	...
	protected void checkLocaleKeyOfFormField(PaymentUserContext userContext, String localeKey, List<Message> messageList)
	{
	...
	protected void checkParameterNameOfFormField(PaymentUserContext userContext, String parameterName, List<Message> messageList)
	{
	...
	protected void checkTypeOfFormField(PaymentUserContext userContext, String type, List<Message> messageList)
	{
	...
	protected void checkFormIdOfFormField(PaymentUserContext userContext, String formId, List<Message> messageList)
	{
	...
	protected void checkPlaceholderOfFormField(PaymentUserContext userContext, String placeholder, List<Message> messageList)
	{
	...
	protected void checkDefaultValueOfFormField(PaymentUserContext userContext, String defaultValue, List<Message> messageList)
	{
	...
	protected void checkDescriptionOfFormField(PaymentUserContext userContext, String description, List<Message> messageList)
	{
	...
	protected void checkFieldGroupOfFormField(PaymentUserContext userContext, String fieldGroup, List<Message> messageList)
	{
	...
	protected void checkMinimumValueOfFormField(PaymentUserContext userContext, String minimumValue, List<Message> messageList)
	{
	...
	protected void checkMaximumValueOfFormField(PaymentUserContext userContext, String maximumValue, List<Message> messageList)
	{
	...
	protected void checkRequiredOfFormField(PaymentUserContext userContext, boolean required, List<Message> messageList)
	{
	...
	protected void checkDisabledOfFormField(PaymentUserContext userContext, boolean disabled, List<Message> messageList)
	{
	...
	protected void checkCustomRenderingOfFormField(PaymentUserContext userContext, boolean customRendering, List<Message> messageList)
	{
	...
	protected void checkCandidateValuesOfFormField(PaymentUserContext userContext, String candidateValues, List<Message> messageList)
	{
	...
	protected void checkSuggestValuesOfFormField(PaymentUserContext userContext, String suggestValues, List<Message> messageList)
	{
	...
	protected void checkVersionOfFormField(PaymentUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfFormAction(PaymentUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkLabelOfFormAction(PaymentUserContext userContext, String label, List<Message> messageList)
	{
	...
	protected void checkLocaleKeyOfFormAction(PaymentUserContext userContext, String localeKey, List<Message> messageList)
	{
	...
	protected void checkActionKeyOfFormAction(PaymentUserContext userContext, String actionKey, List<Message> messageList)
	{
	...
	protected void checkLevelOfFormAction(PaymentUserContext userContext, String level, List<Message> messageList)
	{
	...
	protected void checkUrlOfFormAction(PaymentUserContext userContext, String url, List<Message> messageList)
	{
	...
	protected void checkFormIdOfFormAction(PaymentUserContext userContext, String formId, List<Message> messageList)
	{
	...
	protected void checkVersionOfFormAction(PaymentUserContext userContext, int version, List<Message> messageList)
	{
		...
		if (!(baseUserContext instanceof PaymentUserContext)){
			super.checkAccess(baseUserContext, methodName, parameters);
			return accessOK();
		}
		PaymentUserContext userContext = (PaymentUserContext) baseUserContext;
	...
	protected void throwExceptionIfHasErrors(PaymentUserContext userContext, List<Message> messageList, Class<? extends PaymentException> exceptionClazz) throws Exception{
		//translate messages;
	...
	*/
	...
	protected void checkDateNow(Date likeTime, int i, Object now,
			String targetFieldName, PaymentException exception) {
