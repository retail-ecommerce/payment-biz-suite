...
const ViewMapping = {
  ...
  'com.doublechaintech.payment.platform.Platform': {name:'platform'},
  'com.doublechaintech.payment.userdomain.UserDomain': {name:'userDomain'},
  'com.doublechaintech.payment.userwhitelist.UserWhiteList': {name:'userWhiteList'},
  'com.doublechaintech.payment.secuser.SecUser': {name:'secUser'},
  'com.doublechaintech.payment.secuserblocking.SecUserBlocking': {name:'secUserBlocking'},
  'com.doublechaintech.payment.userapp.UserApp': {name:'userApp'},
  'com.doublechaintech.payment.listaccess.ListAccess': {name:'listAccess'},
  'com.doublechaintech.payment.objectaccess.ObjectAccess': {name:'objectAccess'},
  'com.doublechaintech.payment.loginhistory.LoginHistory': {name:'loginHistory'},
